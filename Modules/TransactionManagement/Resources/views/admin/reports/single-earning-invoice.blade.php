                ...
                <table class="fz-10">
                    <tr>
                        ...
                        <td style="padding:0;text-align:right">
                            <img width="160" src="{{$businessLogo? dynamicStorage("storage/app/public/business/".$businessLogo):dynamicAsset('public/assets/admin-module/img/invoice-logo.png')}}" alt="{{$businessName}}">
                            <div class="font-normal">
                                {{$businessAddress}}
                            </div>
                            <div class="font-normal">
