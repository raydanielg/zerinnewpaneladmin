...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $serviceInterfacePath = base_path('Modules/PromotionManagement/Service/Interfaces');
        ...
        foreach ($serviceFiles as $file) {
            ...
            if (File::exists($interfacePath)) {
                $serviceInterface = 'Modules\PromotionManagement\Service\Interfaces\\' . $interfaceName;
