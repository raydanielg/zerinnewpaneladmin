...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $serviceInterfacePath = base_path('Modules/TransactionManagement/Service/Interfaces');
        ...
        foreach ($serviceFiles as $file) {
            ...
            if (File::exists($interfacePath)) {
                $serviceInterface = 'Modules\TransactionManagement\Service\Interfaces\\' . $interfaceName;
