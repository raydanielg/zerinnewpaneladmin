                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap justify-content-between gap-3 mb-4">
                                <h5 class="d-flex align-items-center gap-2 text-capitalize">
                                    <img width="20" src="{{dynamicAsset('public/assets/admin-module/img/icons/google.png')}}"
                            ...
                            <form action="{{route('admin.business.configuration.third-party.social-login.update')}}"
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="submit" class="btn btn-primary cmn_focus">{{translate('save')}}</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-wrap justify-content-between gap-3 mb-4">
                                <h5 class="d-flex align-items-center gap-2 text-capitalize">
                                    <img width="20" src="{{dynamicAsset('public/assets/admin-module/img/icons/facebook.png')}}"
                                         alt="" class="dark-support">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary cmn_focus"
