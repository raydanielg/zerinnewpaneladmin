...
use Modules\PromotionManagement\Service\Interfaces\CouponSetupVehicleCategoryServiceInterface;

class CouponSetupVehicleCategoryService extends BaseService implements Interfaces\CouponSetupVehicleCategoryServiceInterface
{
    ...
    public function create(array $data): ?Model
    {
        $storeData = [
            ...
            'image'=>fileUploader('promotion/banner/', APPLICATION_IMAGE_FORMAT, $data['banner_image']),
        ];
    ...
    public function update(int|string $id, array $data = []): ?Model
    {
        ...
        if (array_key_exists('brand_logo', $data)) {
            $updateData = array_merge($updateData,[
                'image'=>fileUploader('promotion/banner/', APPLICATION_IMAGE_FORMAT, $data['banner_image'], $model->image),
            ]);
        }
