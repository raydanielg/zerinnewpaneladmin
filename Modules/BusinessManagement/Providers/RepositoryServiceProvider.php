...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $serviceInterfacePath = base_path('Modules/BusinessManagement/Service/Interfaces');
        ...
        foreach ($serviceFiles as $file) {
            ...
            if (File::exists($interfacePath)) {
                $serviceInterface = 'Modules\BusinessManagement\Service\Interfaces\\' . $interfaceName;
