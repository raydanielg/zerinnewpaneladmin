...
class CustomerLevelService extends BaseService implements CustomerLevelServiceInterface
{
    ...
    public function create(array $data): ?Model
    {
        $storeData = [
            ...
            'image' => fileUploader('customer/level/', APPLICATION_IMAGE_FORMAT, $data['image']),
            'user_type' => CUSTOMER,
        ];
    ...
    public function update(int|string $id, array $data = []): ?Model
    {
        ...
        if (array_key_exists('image', $data)) {
            $updateData = array_merge($updateData, [
                'image' => fileUploader('customer/level/', APPLICATION_IMAGE_FORMAT, $data['image'], $model?->image)
            ]);
        }
        if ($data['reward_type'] !== 'no_rewards') {
            $updateData = array_merge($updateData, [
