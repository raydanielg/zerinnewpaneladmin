...
class ParcelWeightService extends BaseService implements ParcelWeightServiceInterface
{
    ...
    public function index(array $criteria = [], array $relations = [], array $whereHasRelations = [], array $orderBy = [], ?int $limit = null, ?int $offset = null, array $withCountQuery = [], array $appends = [], array $groupBy = []): Collection|LengthAwarePaginator
    {
        ...
        $whereHasRelations = [];
        return $this->baseRepository->getBy(criteria: $data, searchCriteria: $searchData, whereInCriteria: $whereInCriteria, whereBetweenCriteria: $whereBetweenCriteria, whereHasRelations: $whereHasRelations, relations: $relations, orderBy: $orderBy, limit: $limit, offset: $offset, withCountQuery: $withCountQuery,groupBy: $groupBy); // TODO: Change the autogenerated stub
    }
    ...
    public function export(array $criteria = [], array $relations = [], array $orderBy = [], ?int $limit = null, ?int $offset = null, bool $onlyTrashed = false, bool $withTrashed = false): Collection|LengthAwarePaginator|\Illuminate\Support\Collection
    {
        return $this->index(criteria: $criteria, orderBy: $orderBy)->map(function ($item) {
            return [
                'Id' => $item['id'],
                'Min Weight' => $item['min_weight'] . (businessConfig(key: 'parcel_weight_unit')?->value ?? 'kg'),
                'Max Weight' => $item['max_weight'] . (businessConfig(key: 'parcel_weight_unit')?->value ?? 'kg'),
                'Weight Range' => $item['min_weight'] . '-' . $item['max_weight'] . (businessConfig(key: 'parcel_weight_unit')?->value ?? 'kg'),
