...
class CustomerSettingController extends BaseController
{
    ...
    public function index(?Request $request, string $type = null): View|Collection|LengthAwarePaginator|null|callable|RedirectResponse
    {
        ...
        $customerVerificationStatus = $this->businessSettingService->findOneBy(criteria: ['key_name'  => 'customer_verification'])?->value ?? 0;
        return view('businessmanagement::admin.business-setup.customer', compact('settings', 'customerVerificationStatus'));
    }
