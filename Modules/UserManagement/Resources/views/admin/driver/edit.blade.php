                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex flex-column justify-content-around gap-3">
                                            ...
                                            <div class="gap-3 d-flex custom cmn_focus" id="multi_image_picker" tabindex="7">
                                            </div>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <div class="pb-3">
                            ...
                            <p class="opacity-75">
                                {{ translate(key: 'File Format - {format}, Image Size - Maximum {imageSize}', replace: ['format' => IMAGE_ACCEPTED_EXTENSIONS . ', .doc, .docx, .pdf', 'imageSize' => $maxSize]) }}
                            </p>
                        </div>
