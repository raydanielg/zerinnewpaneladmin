                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="character-count">
                                    <input id="short_desc" name="short_desc" class="form-control character-count-field"
                                           ...
                                           value="{{ $coupon->description }}" tabindex="2" required/>
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="mb-4">
                                    ...
                                    <input type="number" id="limit_same_user" name="limit_same_user"
                                           class="form-control"
                                           placeholder="Ex: 10" value="{{$coupon->limit}}" required tabindex="5">
                                </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                                <div class="mb-4">
                                    ...
                                    <input type="date" value="{{date('Y-m-d',strtotime($coupon->start_date))}}"
                                           id="start_date"
                                           min="{{ \Carbon\Carbon::createFromFormat('Y-m-d', $coupon->start_date)->format('Y-m-d') }}"
                                           name="start_date" class="form-control" required tabindex="6">
                                </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                                <div class="mb-4">
                                    ...
                                    <input type="date" id="end_date"
                                           ...
                                           min="{{ \Carbon\Carbon::createFromFormat('Y-m-d', $coupon->end_date)->format('Y-m-d') }}"
                            ...
                            <div class="col-sm-6 col-xl-4 min_trip_amount">
                                <div class="mb-4">
                                    ...
                                    <input type="number" id="minimum_trip_amount" name="minimum_trip_amount"
                                           ...
                                           value="{{ $coupon->min_trip_amount }}" required tabindex="8">
                                </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                                <div class="mb-4">
                                    ...
                                    <div class="position-relative">
                                        <input type="number" id="coupon" value="{{$coupon->coupon}}" name="coupon"
                                               class="form-control" placeholder="Ex: 5" step="any" required tabindex="9">
                                        <select class="js-select currency-type-select" id="amount_type"
                                                name="amount_type" required tabindex="10">
                                            <option
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="mb-4">
                                    ...
                                    <input type="number" id="max_coupon" name="max_coupon_amount"
                                           class="form-control"
                                           placeholder="Ex: 60" value="{{ $coupon->max_coupon_amount }}" step=".01" tabindex="11">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-start">
                            <div class="col-sm-6 col-xl-4 user_level">
                                <div class="mb-4">
                                    ...
                                    <select class="js-select-2 cmn_focus" id="customerLevelCouponType"
                                            ...
                                            name="customer_level_coupon_type[]" multiple="multiple" required tabindex="12">
                                        <option
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="mb-4 text-capitalize">
                                    ...
                                    <select class="js-select-2 cmn_focus" id="customerCouponType"
                                            data-placeholder="{{translate('select_customer')}}"
                                            name="customer_coupon_type[]" multiple="multiple" required tabindex="13">
                                        <option
                            ...
                            <div class="col-sm-6 col-xl-4 vehicle_category">
                                <div class="mb-4 text-capitalize">
                                    ...
                                    <select id="categoryCouponType" class="js-select-2 cmn_focus"
                                            data-placeholder="{{translate('select_category')}}"
                                            name="category_coupon_type[]" multiple="multiple" required tabindex="14">
                                        <option
                            ...
                            <div class="col-sm-12">
                                <div class="mb-4 text-capitalize">
                                    ...
                                    <select class="js-select-2 cmn_focus" id="zoneDiscountType"
                                            ...
                                            multiple="multiple" required tabindex="15">
                                        <option
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            <button class="btn btn-primary cmn_focus" type="submit" tabindex="16">{{ translate('update') }}</button>
                        </div>
                    </div>
                </div>
            </form>
