...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $serviceInterfacePath = base_path('Modules/ChattingManagement/Service/Interfaces');
        ...
        foreach ($serviceFiles as $file) {
            ...
            if (File::exists($interfacePath)) {
                $serviceInterface = 'Modules\ChattingManagement\Service\Interfaces\\' . $interfaceName;
