    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between gap-3 align-items-center mb-4">
                ...
                <button type="button" class="btn btn-primary cmn_focus" data-bs-toggle="modal"
            ...
            <div class="alert alert--primary d-flex align-items-center alert-dismissible gap-1 justify-content-center"
                ...
                <img src="{{dynamicAsset('public/assets/admin-module/img/hint.png')}}" alt="hint" width="18" height="18">
            ...
            <form action="{{route('admin.driver.level.store')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row g-4 justify-content-between align-items-center">
                                            <div class="col-sm-6 col-xl-5">
                                                <div class="mb-4">
                                                    ...
                                                    <select class="js-select cmn_focus" name="sequence" id="select_level_number"
                                                            required tabindex="1">
                                            ...
                                            <div class="bg-input p-4 rounded">
                                                <div class="row align-items-end g-4">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="js-select cmn_focus" name="reward_type" id="rewardType"
                                                                required tabindex="4">
                                                    ...
                                                    <div id="rewardAmountDiv" class="col-sm-6 d-none">
                                                        ...
                                                        <input type="number" step=".01" name="reward_amount" max="999999999"
                                                               ...
                                                               placeholder="{{ translate('ex') }}: 500" tabindex="5">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div>
                                                                            <input type="number" name="targeted_ride"
                                                                                   ...
                                                                                   class="form-control"
                                                                                   placeholder="{{ translate('Minimum Ride Number') }}" tabindex="6">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <div>
                                                                            <input type="number"
                                                                                   ...
                                                                                   placeholder="{{ translate('Points') }}" tabindex="7">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row g-3">
                                                                    <div class="col-sm-6">
                                                                        <input type="number" step=".01" min=".01"
                                                                               ...
                                                                               placeholder="{{ translate('minimum_earn_amount') }}" tabindex="8">
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <input type="number"
                                                                               ...
                                                                               placeholder="{{ translate('Points') }}" tabindex="9">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="row g-3">
                                                                    <div class="col-sm-6">
                                                                        <input type="number" name="targeted_cancel"
                                                                               ...
                                                                               max="100" step="1"
                                                                               class="form-control"
                                                                               placeholder="{{ translate('maximum_cancellation_rate') }}" tabindex="10">
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <input type="number"
                                                                               ...
                                                                               step="1"
                                                                               placeholder="{{ translate('Points') }}" tabindex="11">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="row g-3">
                                                                    <div class="col-sm-6">
                                                                        <input type="number" min="1" step="1"
                                                                               ...
                                                                               placeholder="{{ translate('minimum_review_receive') }}" tabindex="12">
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <input type="number"
                                                                               ...
                                                                               placeholder="{{translate('Points')}}" tabindex="13">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="d-flex justify-content-end gap-3 mt-3">
                    <button class="btn btn-secondary cmn_reset" type="reset" tabindex="14">{{translate('reset')}}</button>
                    <button class="btn btn-primary cmn_focus" type="submit" tabindex="15">{{translate('save')}}</button>
                </div>
            </form>
        </div>
    </div>
...
@push('script')
    ...
    <script src="{{ dynamicAsset('public/assets/admin-module/js/level/level.js') }}"></script>
