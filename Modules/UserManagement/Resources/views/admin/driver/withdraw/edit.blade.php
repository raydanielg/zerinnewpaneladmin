                            ...
                            <div class="row gy-4 align-items-end">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex gap-2 align-items-center mb-3">
                                        <input type="checkbox"
                                               id="makeMethodDefault" class="cmn_focus" {{$method['is_default'] ? 'checked' : ''}} name="is_default" tabindex="3">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1 d-flex justify-content-end">
                                                    <button type="button" class="btn btn-outline-danger btn-action remove-field" data-value="${counter}" tabindex="4">
                                            ...
                                            <div class="col-md-4 mb-4">
                                                ...
                                                <select class="form-control js-select cmn_focus" name="field_type[{{$key}}]" required
                                            ...
                                            <div class="col-12">
                                                <div class="d-flex align-items-center gap-2 justify-content-end">
                                                    ...
                                                    <input type="checkbox" value="1"
                                                           name="is_required[{{$key}}]" id="flexCheckDefault__{{$key}}" checked tabindex="8">
                                                    @else
                                                        <input type="checkbox" value="1"
                                                               name="is_required[{{$key}}]" id="flexCheckDefault__{{$key}}" tabindex="8">
                                                    @endif
            ...
            $('#add-more-field').on('click', function (event) {
                if (counter < 15) {
                    ...
                    $('#custom-field-section').append(
                        ...
                        <span class="text-danger">*</span></label>
                    <select class="form-control js-select cmn_focus" name="field_type[]" required id=field_type${counter}>
