...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $serviceInterfacePath = base_path('Modules/VehicleManagement/Service/Interfaces');
        ...
        foreach ($serviceFiles as $file) {
            ...
            if (File::exists($interfacePath)) {
                $serviceInterface = 'Modules\VehicleManagement\Service\Interfaces\\' . $interfaceName;
