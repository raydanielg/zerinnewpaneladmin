...
<div class="floating-ai-button">
    <button type="button" class="btn btn-lg rounded-circle shadow-lg" data-bs-toggle="modal" data-bs-target="#aiAssistantModalBlog"
        ...
        <span class="position-relative z-1 text-white d-flex flex-column gap-1 align-items-center">
            <img width="16" height="17" src="{{ dynamicAsset('public/assets/admin-module/img/ai/hexa-ai.svg') }}" alt="">
            <span class="fs-12 fw-semibold text-absolute-white">{{ translate('Use_AI') }}</span>
        </span>
    </button>
...
<div class="modal fade p-0" id="aiAssistantModalBlog" tabindex="-1" aria-labelledby="aiAssistantModalBlogLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-slideInRight modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-fafafa d-flex gap-2 aign-items-center justify-content-between">
                <button type="button" class="btn-close m-0" data-bs-toggle="modal"></button>
                <h5 class="modal-title d-flex align-items-center gap-2 aiAssistantModalBlogLabel mx-auto" id="aiAssistantModalBlogLabel">
                    <span class="square-div">
                        <span class="ai-btn-animation">
                            <span class="gradientCirc"></span>
                        </span>
                        <img class="position-relative z-1" width="15" height="12" src="{{ dynamicAsset('public/assets/admin-module/img/ai/blink-right.svg') }}" alt="">
                    </span>
            ...
            <div class="modal-body">
                    ...
                    <div class="text-center mb-4">
                        <div class="ai-avatar mb-3">
                            <div class="avatar-circle mx-auto">
                                ...
                                <img class="position-relative z-1 w-40px h-auto" width="40" height="34" src="{{ dynamicAsset('public/assets/admin-module/img/ai/blink-right.svg') }}" alt="">
                            </div>
                        </div>

                        <div class="ai-greeting mb-5">
                            <h4 class="text-title">{{ translate('Hi_There') }},</h4>
                            <h2 class="fs-22 text-dark mb-2">{{ translate('I_am_here_to_help_you') }}!</h2>
                            <p class="">
                        ...
                        <div class="ai-actions d-flex flex-column align-items-center gap-3">
                            <a href="javascript:" type="button" class="btn btn-outline-primary text-dark bg-transparent rounded-10 w-100 max-w-250 d-flex gap-2 ai-action-btn-blog"
                                data-action="upload">
                                <img width="18" height="18" src="{{ dynamicAsset('public/assets/admin-module/img/ai/picture.svg') }}" alt="">
                                <span class="text-title">{{ translate('Upload_Image') }}</span>
                            </a>
                            <a href="javascript:" type="button" class="btn bg-F6F6F6 border text-dark rounded-10 w-100 max-w-250 d-flex gap-2 ai-action-btn-blog"
                                data-action="title">
                                <img width="18" height="18" src="{{ dynamicAsset('public/assets/admin-module/img/ai/text-generate.svg') }}" alt="">
                ...
                <div id="uploadImageContentBlog" class="ai-modal-content-blog" style="display: none;">
                    <div class="d-flex justify-content-center align-items-end w-100">
                        <div class="">
                            ...
                            <div class="text-center mb-30 upload-image-for-generating-content">
                                <label class="upload-zone w-100 mx-auto mb-30" id="chooseImageBtnBlog">
                                    <input type="file" id="aiImageUploadBlog"  hidden class="image-compressor d-none" accept="image/*">
                                    ...
                                    <div class="text-box mx-auto">
                                        <div class="w-100 d-flex flex-column gap-2 justify-content-center align-items-center py-4">
                                            <img width="40" height="40" src="{{ dynamicAsset('public/assets/admin-module/img/ai/image-upload.svg') }}"
                                                alt="">
                                            <div class="text-info fs-12 fw-medium">{{ translate('Add_Image') }}</div>
                                        </div>
                                    </div>
                                    <div id="imagePreviewBlog" class="w-fit-content mx-auto position-relative" style="display: none;">
                                        ...
                                        <div class="d-flex justify-content-center gap-2 flex-wrap">
                                            <a href="javascript:" type="button" class="btn btn-danger p-0 square-div z-2 fs-16 remove_image_btn" id="removeImageBtn"
                                ...
                                <div class="text-center analyzeImageBtn_wrapper">
                                    <button
                                        type="button"
                                        class="btn btn-primary text-white mb-3 d-flex align-items-center gap-2 opacity-1 border-0 mx-auto px-4 py-3 position-relative"
                                        id="analyzeBlogImageBtn"
                                        data-route="{{ route('admin.ai.blog.generate-title-from-contents') }}"
                                        >
                                        ...
                                        <span class="position-relative z-1 d-flex gap-2 align-items-center">
                                            <span class="d-flex align-items-center bg-transparent text-absolute-white btn-text">
                                                {{ translate('Generate_Blog') }}
                                            </span>
                                            <img width="17" height="15" src="{{ dynamicAsset('public/assets/admin-module/img/ai/blink-left.svg') }}"
                                                alt="">
                                        </span>
                                    </button>
                                </div>
                ...
                <div id="giveTitleContentBlog" class="ai-modal-content-blog" style="display: none;">
                    <div class="mb-4">
                        <div class="giveTitleContent_text mb-30">
                            <h5 class="mb-3 text-body lh-base">
                                {{ translate('great!') }}
                                <br>
                            ...
                            <p class="mb-0">{{ translate('feel_free_to_describe_it_your_own_way!') }}</p>
                        </div>
                        ...
                        <div class="text-center generateTitleBtn_wrapper">
                            <button type="button"
                                    class="btn btn-primary text-white mb-3 d-flex align-items-center gap-2 opacity-1 border-0 mx-auto px-4 py-3 position-relative"
                                    id="generateBlogTitleBtn"
                                    data-route="{{ route('admin.ai.blog.generate-title-suggestion') }}"
                                    >
                                <span class="ai-btn-animation d-none">
                                    <span class="gradientRect"></span>
                                </span>
                    ...
                    <div id="generatedTitles" style="display: none;">
                        <div class="text-primary generate_btn_wrapper show_generating_text d-none mb-3">
                            <div class="btn-svg-wrapper">
                                <img width="18" height="18" class="" src="{{ dynamicAsset('public/assets/admin-module/img/ai/blink-right-small.svg') }}"
                                alt="">
                            </div>
                        ...
                        <h4 class="titlesList_title fs-14 fw-bold text-dark mb-4 d-none">{{ translate('Suggest_Blog_Title') }}</h4>
            ...
            <div class="modal-footer bg-transparent border-0 shadow-none d-flex justify-content-center align-items-center pt-0">
                <div class="bg-F6F6F6 px-2 py-1 rounded text-center">
