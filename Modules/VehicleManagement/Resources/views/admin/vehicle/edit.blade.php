                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4" id="model-selector">
                                            ...
                                            <select class="js-select-ajax theme-input-style w-100 form-control"
                                                ...
                                                data-placeholder="{{ translate('please_select_vehicle_model') }}" required tabindex="2">
                                        ...
                                        <div class="mb-4 text-capitalize">
                                            <label for="vehicle_category"
                                                class="mb-2">{{ translate('vehicle_category') }} <span
                                                    class="text-danger">*</span></label>
                                            <select class="js-select-ajax cmn_focus" id="vehicle_category" name="category_id"
                                                required tabindex="3">
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" id="vin_number" class="form-control" name="vin_number"
                                                value="{{ $vehicle->vin_number }}" placeholder="Ex: 1HGBH41JXMN109186" tabindex="6">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4">
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" maxlength="999999999"
                                                ...
                                                name="parcel_weight_capacity" placeholder="Ex: 10" tabindex="8">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4 text-capitalize">
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4 text-capitalize">
                                            <label for="ownership" class="mb-2">{{ translate('ownership') }} <span
                                                    class="text-danger">*</span></label>
                                            <select class="js-select cmn_focus" id="ownership" name="ownership" required tabindex="10">
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="mb-4 text-capitalize">
                                            <label for="driver" class="mb-2">{{ translate('driver') }} <span
                                                    class="text-danger">*</span></label>
                                            <select class="js-select cmn_focus" id="driver" name="driver_id" required tabindex="11">
                        ...
                        <div class="card mt-3">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-3">
                                    ...
                                    <div class="upload-file file__input cmn_focus rounded-10" id="file__input">
                                        <input type="file" class="upload-file__input2" tabindex="13" accept="{{ IMAGE_ACCEPTED_EXTENSIONS }}, {{ FILE_ACCEPTED_EXTENSIONS }}" multiple/>
