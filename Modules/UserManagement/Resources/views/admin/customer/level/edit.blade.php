        ...
        <div class="container-fluid">
            ...
            <form action="{{ route('admin.customer.level.update', ['id' => $level->id]) }}" method="post"
                                            ...
                                            <div class="col-sm-6 col-xl-5">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="number" disabled class="form-control"
                                                           value="{{ $level->sequence }}" tabindex="1">
                                                </div>
                                                <div class="mb-4">
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        <div class="upload-file auto profile-image-upload-file cmn_focus rounded-10">
                                                            <input type="file" name="image" class="upload-file__input"
                                                                   accept=".png" tabindex="3" data-max-upload-size="{{ $maxSize }}">
                                                                <span class="edit-btn">
                ...
                <div class="d-flex justify-content-end gap-3 mt-3">
                    <button class="btn btn-primary cmn_focus" type="submit" tabindex="14">{{ translate('update') }}</button>
                </div>
            </form>
        </div>
    </div>
