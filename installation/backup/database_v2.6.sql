...
--
-- Host: localhost:3306
-- Generation Time: Aug 27, 2025 at 08:15 AM
...
(56, 'admin_collected_cash', 'Admin collected cash.', '[\"{walletAmount}\"]', 1, 'others', 'fund', 'admin_collected_cash', '2025-04-12 22:55:15', '2025-04-12 22:55:15'),
...
CREATE TABLE `surge_pricing` (
  ...
  `surge_pricing_for` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `zone_setup_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `surge_pricing_service_categories` (
  `id` bigint UNSIGNED NOT NULL,
  `surge_pricing_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `service_category_type` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `service_category_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
